...
// SOLO EL MAESTRO PUEDE INICIAR SESION.
if ($datos[0] != "A") {
    // manejo de sesion.
$_SESSION["idM"] = $datos[1];
$_SESSION["nombreM"] = $datos[2];

// cookies.
setcookie("idM", $datos[1], time() + (86400 * 30), "/");
setcookie("nameM", $datos[2], time() + (86400 * 30), "/");
