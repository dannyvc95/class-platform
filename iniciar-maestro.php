...
if (isset($_COOKIE["idM"])) {
    echo "<meta http-equiv=refresh content=0;URL=menu-maestro.php />";
}
?>
<!DOCTYPE html>
<html lang="es">
    ...
    <body class="text-center">
        ...
        <form class="form-signin" action="http://148.202.152.33/2018/datosudeg.php" method="post">
            ...
            <h1 class="h3 mb-3 font-weight-normal">Maestro</h1>
            ...
            <input type="hidden" name="web" value="https://danielvalle.000webhostapp.com/app/login-m.php">
            ...
            <div class="checkbox mb-3">
                <label>
                    <a href="iniciar-alumno.php"><span>Soy un alumno</span></a>
                </label>
            </div>
